...
SCALE_PATH=$PWD/results/roihu/Navier-WinkelStructured-128
...
# If changed, also change the path in plot_times.py and plot_scalability_bar.py and also the corresponding sif
RET_PATH=$PWD/$CASE_PATH/results_cpu_128
